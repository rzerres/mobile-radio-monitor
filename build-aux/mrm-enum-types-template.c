...
#undef __MRM_IS_ENUM__
#undef __MRM_IS_FLAGS__
#define __MRM_IS_@TYPE@__
...
#endif /* __MRM_IS_ENUM_ */

/**
 * @enum_name@_build_string_from_mask:
 * @mask: bitmask of @EnumName@ values.
 *
 * Builds a string containing a comrma-separated list of nicknames for
